...
class BloodRelationsTrainer:
    ...
    def __init__(self, args):
        ...
        Your task is to CORRECTLY answer multiple-choice questions (MCQs) on one of the topics from "Blood relation", "Seating Arrangements", "Truth-teller and Liar Problems"
    ...
    def _format_reward_func(self, completions, **kwargs) -> List[float]:
        ...
        return [1.0 if match else -3.0 for match in matches]
    ...
    def _correctness_reward_func(self, prompts, completions, answer, **kwargs) -> List[float]:
        ...
        return [2.0 if r == a else -2.0 for r, a in zip(extracted_responses, answer)]
    ...
    def generate_response(self, prompt: str, sys_prompt: str = None) -> str:
        ...
        if sys_prompt is None:
            sys_prompt = self.system_prompt2
...
if __name__ == "__main__":
    ...
    1. SFT TRAINING:
       ...
       python -m trainer \
           ...
           --dataset_file /jupyter-tutorial/AAIPL_129_212_191_47/dataset/new_dataset.json \
